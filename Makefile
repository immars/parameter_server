...
build/caffe_single: build/app/caffe/caffe_single.o $(PS_LIB)
	$(CC) $(CFLAGS) $^ $(LDFLAGS) -o $@	

caffe_all: build/caffe build/caffe_sync build/caffe_share build/caffe_async_share build/caffe_single
